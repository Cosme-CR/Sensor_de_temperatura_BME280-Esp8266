...
// Defina  login Wi-Fi e  chave do  ThingSpeak
const char* ssid = "teste"; // nome  wifi
const char* password = "teste1234"; // senha  wifi
const char* apiKey = "XXXXXXXX"; //  chave de gravação do ThingSpeak
const unsigned long channelID = 11111111;//  ID no ThingSpeak
